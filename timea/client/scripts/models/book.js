...
(function(module) {
  ...
  //invoked in the initsearchformpage the book is an array of books coming from the result of the google api query
  ...
  //invoked in the initsearchresultpage the book ia book coming from the result of the google api query
  Book.findOne = isbn =>
